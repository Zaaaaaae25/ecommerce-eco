<nav class="bg-white border-gray-200 dark:bg-gray-900 sticky top-0">
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" id="home"" />
...
<button type="button" class="relative text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
  ...
  <li>
    <a href="/"
       class="{{ request()->is('/') ? 'text-blue-700 bg-blue-100 md:bg-transparent md:text-blue-700' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700' }} block py-2 px-3 rounded-sm md:p-0">
       Home
    </a>
  </li>
  <li>
    <a href="/product"
       class="{{ request()->is('product*') ? 'text-blue-700 bg-blue-100 md:bg-transparent md:text-blue-700' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700' }} block py-2 px-3 rounded-sm md:p-0">
       Shop
    </a>
  </li>
  <li>
    <a href="Ai Asistant"
       class="text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 block py-2 px-3 rounded-sm md:p-0">
       Ai Asistant
    </a>
  </li>
  <li>
